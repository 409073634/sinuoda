      ...
      <div class="col-xs-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#ionicons" data-toggle="tab">Ionicons</a></li>
          ...
          <div class="tab-content">
            ...
            <div id="ionicons" class="tab-pane">
              <ul id="ionicons_list">
              ...
              <div id="icon-panel">
                <input type="text" id="icon-name" readonly :value="iconName">
              </div>
...
export default {
  ...
  mounted () {
    this.iconPanel = document.getElementById('icon-panel')
    let iconElements = document.querySelectorAll('#ionicons li')
    iconElements.forEach(iconElement => {
      this.addEvent(iconElement, 'click', this.panelClick)
    })
  },
  methods: {
    addEvent (el, ev, fn) {
    ...
    panelClick (e) {
      ...
      this.iconPanel.style.top = (target.offsetTop + 60) + 'px'
      this.iconPanel.style.left = (target.offsetLeft - 85) + 'px'
      this.iconName = target.className
    },
    hideIconPanel () {
      if (this.iconPanel.style.top !== '-9999px') {
        this.iconPanel.style.top = '-9999px'
      }
    }
